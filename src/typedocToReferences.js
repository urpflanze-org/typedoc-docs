function typedocToReferences(typedocJSON) {
...
function parseModule(module) {
	...
	if (module.flags && !module.flags.isExternal) {
		if (module.children) {
			for (item of module.children) {
				if (item.flags && !module.flags.isExternal) {
					const r = parse(item)
					if (r) {
...
module.exports = typedocToReferences
